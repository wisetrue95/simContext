...
def main(input_dir):
    file_dir = glob.glob(os.path.join('result', "*.json"))
    # input open
    all_loc_freq_dict = []
    matching_type = "LOC" #TIM
    ...
    ko_model = models.fasttext.load_facebook_model('./fasttext.bin') #fasttext model load
...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_file', default='./result/오헨리_마지막잎새utf-8.json', help='input file')
